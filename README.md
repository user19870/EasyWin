...
``` cpp
 ...
 int main(){ 
	 ...
	 c.button(L"textinbutton",1500,500,100,100,c2);c.inputbox("id2",500,300,100,100,nullptr);c.loopAndStopProcessing();  
...
```cpp
 ...
 int main(){ 
	 ...
	 c.button(L"按鈕",1500,500,100,100,c2);c.inputbox("id2",500,300,100,100,nullptr);c.loopAndStopProcessing();  
